...
'1_yacht_test_'() ->
    {"Yacht", ?_assertMatch(50, yacht:score([5, 5, 5, 5, 5], yacht))}.

'2_not_yacht_test_'() ->
    {"Not Yacht", ?_assertMatch(0, yacht:score([1, 3, 3, 2, 5], yacht))}.

'3_ones_test_'() ->
    {"Ones", ?_assertMatch(3, yacht:score([1, 1, 1, 3, 5], ones))}.
...
'5_no_ones_test_'() ->
    {"No ones", ?_assertMatch(0, yacht:score([4, 3, 6, 5, 5], ones))}.

'6_twos_test_'() ->
    {"Twos", ?_assertMatch(2, yacht:score([2, 3, 4, 5, 6], twos))}.

'7_fours_test_'() ->
    {"Fours", ?_assertMatch(8, yacht:score([1, 4, 1, 4, 1], fours))}.
...
'10_fives_test_'() ->
    {"Fives", ?_assertMatch(10, yacht:score([1, 5, 3, 5, 3], fives))}.

'11_sixes_test_'() ->
    {"Sixes", ?_assertMatch(6, yacht:score([2, 3, 4, 5, 6], sixes))}.
...
'28_choice_test_'() ->
    {"Choice", ?_assertMatch(23, yacht:score([3, 3, 5, 6, 6], choice))}.
