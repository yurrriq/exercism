...
'1_the_sound_for_1_is_1_test_'() ->
    {"the sound for 1 is 1", ?_assertEqual("1", raindrops:convert(1))}.

'2_the_sound_for_3_is_pling_test_'() ->
    {"the sound for 3 is Pling", ?_assertEqual("Pling", raindrops:convert(3))}.

'3_the_sound_for_5_is_plang_test_'() ->
    {"the sound for 5 is Plang", ?_assertEqual("Plang", raindrops:convert(5))}.

'4_the_sound_for_7_is_plong_test_'() ->
    {"the sound for 7 is Plong", ?_assertEqual("Plong", raindrops:convert(7))}.
...
'16_the_sound_for_52_is_52_test_'() ->
    {"the sound for 52 is 52", ?_assertEqual("52", raindrops:convert(52))}.
