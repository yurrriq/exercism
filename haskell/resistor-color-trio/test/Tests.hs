...
cases =
  [ Case
      { input = Resistor (Black, Black, Black),
        expectedLabel = "0 ohms",
        expectedOhms = 0
      },
    Case
      { input = Resistor (Black, Yellow, Black),
        expectedLabel = "4 ohms",
        expectedOhms = 4
      },
    Case
      { input = Resistor (Grey, Orange, Black),
        expectedLabel = "83 ohms",
        expectedOhms = 83
      },
    Case
      { input = Resistor (Blue, Grey, Brown),
        expectedLabel = "680 ohms",
        expectedOhms = 680
      },
    Case
      { input = Resistor (Red, Black, Red),
        expectedLabel = "2 kiloohms",
        expectedOhms = 2e3
      },
    Case
      { input = Resistor (Green, Brown, Orange),
        expectedLabel = "51 kiloohms",
        expectedOhms = 51e3
      },
    Case
      { input = Resistor (White, Violet, Yellow),
        expectedLabel = "970 kiloohms",
        expectedOhms = 970e3
      },
    Case
      { input = Resistor (White, Black, Green),
        expectedLabel = "9 megaohms",
        expectedOhms = 9e6
      },
    Case
      { input = Resistor (Brown, Grey, Blue),
        expectedLabel = "18 megaohms",
        expectedOhms = 18e6
      },
    Case
      { input = Resistor (Red, Violet, Violet),
        expectedLabel = "270 megaohms",
        expectedOhms = 270e6
      },
    Case
      { input = Resistor (Yellow, Black, Grey),
        expectedLabel = "4 gigaohms",
        expectedOhms = 4e9
      },
    Case
      { input = Resistor (Orange, Blue, White),
